...
namespace MovieTutorial3.MovieDB
{
    ...
    public sealed class MovieCastRow : Row<MovieCastRow.RowFields>, IIdRow, INameRow
    {
        ...
        [DisplayName("Person"), NotNull, ForeignKey("[mov].[Person]", "PersonId"), LeftJoin("jPerson"), TextualField(nameof(PersonFirstName))]
        public int? PersonId
        {
        ...
        [DisplayName("Movie Primary Image"), Expression("jMovie.[PrimaryImage]")]
        public string MoviePrimaryImage
        {
            get => fields.MoviePrimaryImage[this];
            set => fields.MoviePrimaryImage[this] = value;
        }

        [DisplayName("Movie Gallery Images"), Expression("jMovie.[GalleryImages]")]
        public string MovieGalleryImages
        {
            get => fields.MovieGalleryImages[this];
            set => fields.MovieGalleryImages[this] = value;
        }
        ...
        [DisplayName("Person Primary Image"), Expression("jPerson.[PrimaryImage]")]
        public string PersonPrimaryImage
        {
            get => fields.PersonPrimaryImage[this];
            set => fields.PersonPrimaryImage[this] = value;
        }

        [DisplayName("Person Gallery Images"), Expression("jPerson.[GalleryImages]")]
        public string PersonGalleryImages
        {
            get => fields.PersonGalleryImages[this];
            set => fields.PersonGalleryImages[this] = value;
        }
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public StringField MoviePrimaryImage;
            public StringField MovieGalleryImages;
            ...
            public StringField PersonPrimaryImage;
            public StringField PersonGalleryImages;
        }
    }
}