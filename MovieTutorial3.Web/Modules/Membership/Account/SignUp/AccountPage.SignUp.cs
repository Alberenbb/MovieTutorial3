...
using MovieTutorial3.Administration;
using MovieTutorial3.Administration.Entities;
using MovieTutorial3.Administration.Repositories;
using MovieTutorial3.Common;
using Serenity;
using Serenity.Data;
...
namespace MovieTutorial3.Membership.Pages
{
